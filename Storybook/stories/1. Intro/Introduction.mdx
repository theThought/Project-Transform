...
## HTML markup
- Most of the HTML has been copied from [Project Transform's staging server](https://online-stg.ipsosinteractive.com/mrIWeb/mrIWeb.dll?I.Project=S20223280&i.test=1), and edited for simplicity.
