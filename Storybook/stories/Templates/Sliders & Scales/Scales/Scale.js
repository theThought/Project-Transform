                ...
                <questions data-position="below">
                    <question data-position="below">
                        ...
                        <div class="o-question-response o-question-scale-horizontal" data-questiongroup="_QPassive10Scale" data-readonly="false" data-position="below">
                            ...
                            <!-- Special codes -->
                            <div data-exclusive="true" data-questionid="_Q0_X0" data-questiongroup="_QPassive10Scale" data-position="side" data-hidden="false" class="m-option-base side" style="">
                                <script>app.registerComponent('mOptionBase','_Q0_X0','_QPassive10Scale');</script>
                                <input class="hiddencontrol" type="radio" name="_QPassive10Scale_Xcode1" id="_Q0_X0" style="" value="code1"/>
                                <label for="_Q0_X0">
                                    <span class="a-icon-multistate" data-icontype="single"></span>
                                    <span class="a-label-option">first special code</span>
                                </label>
                            </div>
                            <div data-exclusive="true" data-questionid="_Q0_X1" data-questiongroup="_QPassive10Scale" data-position="side" data-hidden="false" class="m-option-base side" style="">
                                <script>app.registerComponent('mOptionBase','_Q0_X1','_QPassive10Scale');</script>
                                <input class="hiddencontrol" type="radio" name="_QPassive10Scale_Xcode2" id="_Q0_X1" style="" value="code2"/>
                                <label for="_Q0_X1">
                                    <span class="a-icon-multistate" data-icontype="single"></span>
