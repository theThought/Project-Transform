        ...
        <div class="o-question-core">
            <div class="o-question-information-and-messages" style="flex-basis: ${args.pagePropertySideBySide}%;">
                <div class="o-question-information">
                    <div class="o-question-information-content">This is a text question</div>
                </div>
...
<div class="surroundcontent">
    ...
    <div class="o-question-container focused cover-off config-complete ${args.pageLayout === 'sidebyside' ? 'sidebyside' : ''}">
        ...
        <div class="o-question-core">
            <div class="o-question-information-and-messages" style="flex-basis: ${args.pagePropertySideBySide}%;">
                <div class="o-question-information">
                    <div class="o-question-information-content">Enter your date of birth</div>
                </div>
                <div class="o-question-alternatives"><!-- alternative labels go here --></div>
            </div>
            <div class="o-question-response">
                <questions data-position="below">
                    <question data-position="below">
                        ...
                        <div class="o-question-response o-question-singlelineedit" data-questiongroup="_QBirthDate" data-readonly="false" data-position="below">
                            <script>app.registerComponent('oQuestionSinglelineedit','_Q0','_QBirthDate');</script>
                            <input data-questionid="_Q0" data-questiongroup="_QBirthDate" data-position="below" type="text" step="any" name="_QBirthDate" id="_Q0" autocomplete="off" style="" maxlength="40" value="" data-value="" class="a-input-singlelineedit below"/>
                            <script>app.registerComponent('aInputSinglelineedit','_Q0','_QBirthDate');</script>
                        </div>
