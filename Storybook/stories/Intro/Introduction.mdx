...
## Code patterns
- The HTML is currently taken from the project's [staging server](https://zeroheight.com/61aada3a1/p/264eaa-project-transform) output, and simplified to provide working examples.
- The CSS/JavaScript code is loaded from an Ipsos sandbox inside `.storybook/preview-head.html`.
